...
<div id="header2" style="position: fixed; z-index: 5; width: 100%;">
	<nav class="navbar navbar-expand-lg p-3  navbar-light "
		...
		<a class="navbar-brand"> <img src="/image/1.png"
		...
		<div class="collapse navbar-collapse d-flex justify-content-center"
			...
			<form action="<%=request.getContextPath() + "/ItemsMVC/member/searchByName"%>"
				...
				<input class="form-control mr-sm-2" style="width: 80%"
					...
					aria-label="Search">
				<button class="btn btn-info px-3 py-2 font-weight-bold my-2 my-sm-0" type="submit">Search</button>
			</form>
			<ul class="navbar-nav mr-auto ">

				<li class="nav-item active"><a style="color: white;"
					class="nav-link btn btn-outline-warning ml-3 font-weight-bold"
					href="<%=request.getContextPath() + "/member/welcomeClientServlet"%>">Book List
				</a></li>
